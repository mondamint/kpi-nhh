...
export function AppSidebar() {
  ...
  const getNavCls = ({
    ...
    isActive: boolean;
  }) => isActive ? "bg-primary text-primary-foreground font-medium hover:bg-primary hover:text-primary-foreground" : "hover:bg-muted/50";
  return <Sidebar className={isCollapsed ? "w-14" : "w-64"} collapsible="icon">
      ...
      <SidebarContent className="bg-gray-950">
        <SidebarGroup className="bg-slate-700">
          <SidebarGroupLabel className="bg-slate-100">เมนูหลัก</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
        ...
        <SidebarGroup>
          <SidebarGroupLabel className="bg-zinc-100">ระบบ</SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
